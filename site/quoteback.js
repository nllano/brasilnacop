...
document.addEventListener("DOMContentLoaded", function(){
    ...
    for(var item=0; item < index.length; item++ ){   
      ...
      <div class="quoteback-container" role="quotation" aria-labelledby="quoteback-author" tabindex="0">
          ...
          <div class="quoteback-backlink"><a target="_blank" aria-label="Fonte" rel="noopener" href="" class="quoteback-arrow">Fonte <span class="right-arrow">&#8594;</span></a></div>
          </div>  
      </div>`;
      ...
      class QuoteBack extends HTMLElement {
        ...
        connectedCallback() {
          ...
          this.shadowRoot.querySelector('.quoteback-author').setAttribute("aria-label", "Fonte " + this.getAttribute('author'));
